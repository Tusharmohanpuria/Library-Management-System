...
function GetMember({ refresh4, refresh5, refresh6 }) {
    ...
    useEffect(() => {
        ...
        if( refresh4 || refresh5 || refresh6){
            getMemberDetails();
        }
        getMemberDetails()
    }, [API_URL, memberId, refresh4, refresh5, refresh6])
            ...
            <div style={memberId === null ? { display: "none" } : {}}>
                <div className="member-profile-content" id="profile@member" style={memberId === null ? { display: "none" } : {}}>
                    <div className="user-details-topbar">
                        <img className="user-profileimage" src={memberDetails?.photo ? memberDetails.photo : "./assets/images/Profile.png"} alt=""></img>
