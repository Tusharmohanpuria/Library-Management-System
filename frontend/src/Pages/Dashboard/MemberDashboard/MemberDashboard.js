...
function MemberDashboard() {
  ...
  const handleCheckout = (copyId, otp) => {
    ...
    <div className="dashboard">
      <div className="dashboard-card">
        ...
        <div className={sidebar ? 'dashboard-options active' : 'dashboard-options'}>
          ...
          >
            <ReceiptIcon className="dashboard-option-icon" /> SelfCheckout
          </a>
          </p>
        ...
        <div className="dashboard-option-content Top-Box">
        {!showPopup && (
          <>
          <div className="member-profile-content" id="profile@member">
            <div className="user-details-topbar">
              <img
                ...
                src={memberDetails?.photo ? memberDetails?.photo : './assets/images/Profile.png'}
                alt=""
              ></img>
            ...
            <div className="specific-left">
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '30px' }}>
                <p style={{ flex: '1', flexDirection: 'column' }}>
                  ...
                  <span style={{ fontSize: '16px' }}>
                      {memberDetails?.dob ? moment(memberDetails.dob).format('YYYY-MM-DD') : ''}
                  </span>
                </p>
              </div>
            </div>
        ...
        <div id="checkout@member">
        {showPopup && (
          <SelfCheckout onClose={() => setShowPopup(false)} onCheckout={handleCheckout} />
        )}
      </div>
      </div>
      </div>
